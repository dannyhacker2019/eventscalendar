    ...
    <div class="main">
        ...
        <div class="container">
            <div class="sign-up-content">
                <form method="POST" class="signup-form" action="{{ route('frontend.home')}}">
          ...
          <div class="alert alert-success">
              ...
              @endif
              <h2 class="form-title">Register with Upskill</h2>
                ...
                <p class="loginhere">
                    Already have an account ?<a href="{{ route('user.login')}}" class="loginhere-link"> Log in</a>
                </p>
            </div>
        </div>
